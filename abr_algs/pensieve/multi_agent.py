...
def central_agent(net_params_queues, exp_queues):
    ...
    abr_logging.basicConfig(filename=LOG_FILE + '_central',
                            filemode='w',
                            level=abr_logging.INFO)
    ...
    with tf.Session() as sess, open(LOG_FILE + '_test', 'wb'):
        ...
        while True:
            ...
            abr_logging.info('Epoch: ' + str(epoch) +
            ...
            if epoch % MODEL_SAVE_INTERVAL == 0:
                ...
                save_path = saver.save(sess, SUMMARY_DIR + "/" + MODEL_NAME +
                                       str(epoch) + ".ckpt")
                abr_logging.info("Model saved in file: " + save_path)
